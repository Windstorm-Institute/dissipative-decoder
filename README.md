# Paper 5: The Dissipative Decoder

**Thermodynamic Cost Bounds on the Serial Decoding Throughput Basin — and Why Silicon Escapes Them**

Grant Lavell Whitmer III · Windstorm Labs, The Windstorm Institute · Fort Ann, NY, USA

[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.19433048-blue)](https://doi.org/10.5281/zenodo.19433048)
...
**Zenodo**: [10.5281/zenodo.19433048](https://doi.org/10.5281/zenodo.19433048) · **Current version: v1.0** (April 2026)
...
- **[Zenodo record](https://doi.org/10.5281/zenodo.19433048)** — archived with DOI
- **[Website article](https://windstorminstitute.org/articles/dissipative-decoder.html)** — long-form companion

## Experiment Code

Reproducible experiments and raw data for this paper:
**[Windstorm-Labs/dissipative-decoder](https://github.com/Windstorm-Labs/dissipative-decoder)**

---

## Discuss this paper

- **Discuss the paper's ideas** → [Comments on the website article](https://windstorminstitute.org/articles/dissipative-decoder.html#comments) (powered by GitHub Discussions on the website repo)
- **Typo, citation issue, or paper-content correction?** → [Open an Issue on this repo](../../issues)
- **Bug in the analysis code, or a reproduction question?** → [Issue](https://github.com/Windstorm-Labs/dissipative-decoder/issues) or [Discussion](https://github.com/Windstorm-Labs/dissipative-decoder/discussions) on the Labs repo
...
| 5 | [The Dissipative Decoder](https://github.com/Windstorm-Institute/dissipative-decoder) *(this paper)* | [10.5281/zenodo.19433048](https://doi.org/10.5281/zenodo.19433048) |
